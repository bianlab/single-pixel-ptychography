function [ im_unwrapped ] = GoldsteinUnwrap2D_r1( IM, opts )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Outputs: 1. Unwrapped phase image (rads)
%          2. Phase quality map
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if nargin<2
    opts.plotflag   = 0; % [default] figure plot flag 1-Y, 0-N 
    opts.manualseed = 0; % [default] manually choose starting seed point 1-Y, 0-N
end
if ~isfield(opts,'plotflag')
    opts.plotflag = 0;
end
if ~isfield(opts,'manualseed')
    opts.manualseed = 1;
end
...
if(opts.manualseed)  % Chose starting point interactively
  ...
  im_mag1(:,1) = 0;
  im_mag1(:,c_dim) = 0;
  [rowrefn,colrefn] = find(im_mag1 >= 0.99*mag_max); % [original] 0.9
